...
<head>
<meta charset="UTF-8">
<title>ResidentViewComplaint</title>
</head>
<body>
   ...
   <table border="1">
	...
	%>
     <tr>
			...
			<td>
			   <a href="UpdateComplaintServlet?complaintId=<%=complaint.getComplaintId() %>">Edit</a>
			</td>
			<td>
			   <a href="CancelComplaintServlet?complaintId=<%=complaint.getComplaintId() %>">Cancel</a>
			</td>
	</tr>
     <%
